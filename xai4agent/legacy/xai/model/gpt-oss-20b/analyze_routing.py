...
MODEL_PATH = "/root/autodl-tmp/models/gpt-oss-20b"
DATA_PATH = "/root/autodl-tmp/xai/model/gpt-oss-20b/pair_tokens.json"
PROMPTS_PATH = "/root/autodl-tmp/xai/model/gpt-oss-20b/pair_prompts.json"
OUT_DIR = "/root/autodl-tmp/xai/output/gpt-oss-20b"
...
def main():
    parser = argparse.ArgumentParser(description="gpt-oss-20b routing analysis")
