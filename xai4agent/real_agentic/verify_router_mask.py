...
DEFAULT_SERVER = "/root/autodl-tmp/XAI4Agent/xai4agent/serving/fastapi/qwen3coder/server_intervene.py"
...
def resolve_paths(args: argparse.Namespace) -> tuple[Path, Path]:
    ...
    data_path = Path(args.data_path) if args.data_path else run_dir / "real_tool_prompts.json"
    output_path = Path(args.output) if args.output else run_dir / "verify_router_mask.json"
