#!/usr/bin/env python3
"""Dataset-specific pair decode for APPS (call-based subset)."""
...
DEFAULT_PROMPTS = "/root/autodl-tmp/xai/dataset/apps/code/pair/pair_prompts.json"
DEFAULT_TOKENS = "/root/autodl-tmp/xai/dataset/apps/code/pair/pair_tokens.json"
DEFAULT_MODEL = "/root/autodl-tmp/models/qwen3-coder-30b"
DEFAULT_OUTPUT_DIR = "/root/autodl-tmp/xai/output/apps/decode"
DEFAULT_LOG = "/root/autodl-tmp/xai/dataset/apps/code/pair_decode.tsv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Autoregressive decode for APPS paired prompts.")
