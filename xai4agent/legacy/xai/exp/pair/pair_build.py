...
DEFAULT_AGENTIC_PRIMARY = "/root/autodl-tmp/xai/exp/agentic/agentic_output1.json"
DEFAULT_AGENTIC_FALLBACK = "/root/autodl-tmp/xai/exp/agentic/agentic_output.json"
DEFAULT_MODEL = "/root/autodl-tmp/qwen3-8B"
DEFAULT_SERVER = "/root/autodl-tmp/XAI4Agent/xai4agent/legacy/fastapi/qwen3coder/server1.py"
DEFAULT_AGENT = "/root/autodl-tmp/XAI4Agent/xai4agent/legacy/xai/exp/agentic/agent.py"
DEFAULT_PROJECT_ROOT = "/root/autodl-tmp/XAI4Agent/xai4agent/legacy/xai/exp/agentic/projects"
...
def main() -> int:
    ...
    agentic_primary = load_json(Path(args.agentic))
    agentic_fallback = load_json(Path(args.agentic_fallback))
