#!/usr/bin/env python3
"""Build agentic/assisted prompts + aligned tokens for Nemotron-3-Nano-30B-A3B.
...
DEFAULT_MODEL = "/root/autodl-tmp/models/Nemotron-3-Nano-30B-A3B"
DEFAULT_PARQUET = "/root/autodl-tmp/xai/dataset/humaneval/data/test-00000-of-00001.parquet"
DEFAULT_AGENTIC = "/root/autodl-tmp/xai/model/Nemotron-3-Nano-30B-A3B/agentic_output.json"
DEFAULT_ASSISTED = "/root/autodl-tmp/xai/exp/assisted/assisted_output.json"
DEFAULT_OUT_DIR = "/root/autodl-tmp/xai/model/Nemotron-3-Nano-30B-A3B"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build prompts/tokens for Nemotron-3-Nano-30B-A3B.")
