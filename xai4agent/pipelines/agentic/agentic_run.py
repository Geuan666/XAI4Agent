...
DEFAULT_PROJECT_ROOT = "/root/autodl-tmp/XAI4Agent/xai4agent/pipelines/agentic/projects"
DEFAULT_RUN_ROOT = "/root/autodl-tmp/XAI4Agent/experiments/agentic"
AGENT_MODULE_PATH = "/root/autodl-tmp/XAI4Agent/xai4agent/pipelines/agentic/agent.py"
...
def resolve_runtime_paths(args: argparse.Namespace) -> tuple[Path, Path]:
    ...
    output_path = Path(args.output) if args.output else run_dir / "agentic_output.json"
    log_path = Path(args.log) if args.log else run_dir / "agentic_log.tsv"
