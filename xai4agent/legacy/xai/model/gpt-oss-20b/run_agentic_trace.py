#!/usr/bin/env python3
"""Run agentic pipeline against GPT-OSS vLLM to generate message_trace.
...
DEFAULT_OUT = "/root/autodl-tmp/xai/model/gpt-oss-20b/agentic_output.json"
DEFAULT_LOG = "/root/autodl-tmp/xai/model/gpt-oss-20b/agentic_log.tsv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run agentic trace with GPT-OSS vLLM.")
