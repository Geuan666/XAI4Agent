...
PARQUET_FILE = "/root/autodl-tmp/xai/dataset/apps/code/humaneval_like/apps_callbased_test.parquet"
DEFAULT_OUTPUT_FILE = "/root/autodl-tmp/xai/dataset/apps/code/assisted_output.json"
DEFAULT_LOG_FILE = "/root/autodl-tmp/xai/dataset/apps/code/assisted_log.tsv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Assisted coding run for APPS call-based subset.")
