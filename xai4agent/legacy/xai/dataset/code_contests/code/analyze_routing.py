...
DATA_PATH = "/root/autodl-tmp/xai/dataset/code_contests/code/pair_tokens.json"
PROMPTS_PATH = "/root/autodl-tmp/xai/dataset/code_contests/code/pair_prompts.json"
...
def main():
    parser = argparse.ArgumentParser(description="code_contests routing analysis")
