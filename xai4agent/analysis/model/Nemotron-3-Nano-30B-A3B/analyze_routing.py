...
PROMPTS_PATH = "/root/autodl-tmp/xai/model/Nemotron-3-Nano-30B-A3B/pair_prompts.json"
...
def main():
    parser = argparse.ArgumentParser(description="Nemotron-3-Nano-30B-A3B routing analysis")
