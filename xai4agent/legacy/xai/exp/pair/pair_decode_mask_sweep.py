...
DEFAULT_POINTS_JSON = "/root/autodl-tmp/xai/output/humaneval/tables/01-21-09.47/last_token_agentic_minus_assisted_points.json"
DEFAULT_PAIR_DECODE = "/root/autodl-tmp/xai/exp/pair/pair_decode_mask.py"
DEFAULT_PAIR_EVAL = "/root/autodl-tmp/xai/exp/pair/pair_decode_eval.py"
DEFAULT_OUT_BASE = "/root/autodl-tmp/xai/output/humaneval"
DEFAULT_LOG_BASE = "/root/autodl-tmp/xai/exp/pair"
DEFAULT_RESULTS_DIR = "/root/autodl-tmp/xai/output/humaneval/tables"
...
def main() -> int:
    ...
    Path(args.log_base).mkdir(parents=True, exist_ok=True)
    ...
    try:
        for n in sizes:
            ...
            decode_dir = Path(args.out_base) / f"decode_mask_top{n}"
            log_path = Path(args.log_base) / f"pair_decode_mask_top{n}.tsv"
