#!/usr/bin/env python3
"""Run agentic pipeline against Qwen3-30B-A3B vLLM to generate message_trace.
...
DEFAULT_OUT = "/root/autodl-tmp/xai/model/qwen3-30b-a3b/agentic_output.json"
DEFAULT_LOG = "/root/autodl-tmp/xai/model/qwen3-30b-a3b/agentic_log.tsv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run agentic trace with Qwen3-30B-A3B vLLM.")
