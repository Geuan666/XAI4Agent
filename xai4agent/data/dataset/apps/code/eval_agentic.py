...
DEFAULT_OUTPUT = "/root/autodl-tmp/xai/dataset/apps/code/message_trace/agentic_output.json"
...
DEFAULT_RESULTS = "/root/autodl-tmp/xai/dataset/apps/code/agentic_eval_results.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate APPS agentic outputs.")
...
def main() -> int:
    ...
    # override timeout wrapper if needed
    global run_tests
