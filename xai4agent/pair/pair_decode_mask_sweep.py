...
DEFAULT_PAIR_DECODE = "/root/autodl-tmp/XAI4Agent/xai4agent/pair/pair_decode_mask.py"
DEFAULT_PAIR_EVAL = "/root/autodl-tmp/XAI4Agent/xai4agent/pair/pair_decode_eval.py"
